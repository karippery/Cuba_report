...
public class SampleprojectTestContainer extends TestContainer {

    public SampleprojectTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/sampleproject/app.properties",
    ...
    public static class Common extends SampleprojectTestContainer {

        public static final SampleprojectTestContainer.Common INSTANCE = new SampleprojectTestContainer.Common();
